...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
				    ...
				    { "PyCharm", "/opt/pycharm-2021.3/bin/pycharm.sh" },
				    { "GoLand", "sudo -u rszamszur /opt/GoLand-2021.1.3/bin/goland.sh" },
				    { "KeePass", "keepassxc" },
				    { "VSCode", "code" },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
	    ...
	    logout_menu_widget({
                onlock = function() awful.spawn.with_shell('xsecurelock') end
            }),
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "l", function() awful.util.spawn("xset s activate") end,
